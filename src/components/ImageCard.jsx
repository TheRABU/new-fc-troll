      ...
      <section class=" w-full bg-white dark:bg-[#0A2025] py-9 px-8">
        <div class="mx-auto max-w-[1160px] ">
          <header class="h-12 mb-8 justify-between items-center flex">
            <h2 class="text-[#0A2025] dark:text-white text-2xl font-bold font-['Roboto']">
              Shop by Sport
            </h2>
          ...
          <main class="flex items-center flex-col md:flex-row  gap-10">
            <div>
              <img class="mb-7 rounded-xl" src="https://iili.io/33etOiX.png" />
              <div>
                <h3 class="text-[#0A2025] dark:text-white text-2xl font-bold font-['Roboto']">
                  Keni Golf
                </h3>
                <p class="mt-5 mb-8 text-[#0A2025] dark:text-white text-sm font-normal font-['Roboto']">
                  Everything you need for any course
                </p>
                <button class="text-[#3e9d26] text-sm font-semibold font-['Roboto']">
                  Shop
                </button>
              </div>
            </div>
            <div>
              <img class="mb-7 rounded-xl" src="https://iili.io/33etkfn.png" />
              <div>
                <h3 class="text-[#0A2025] dark:text-white text-2xl font-bold font-['Roboto']">
                  Keni basketball
                </h3>
            ...
            <div>
              <img class="mb-7 rounded-xl" src="https://iili.io/33etvls.png" />
              <div>
                <h3 class="text-[#0A2025] dark:text-white text-2xl font-bold font-['Roboto']">
                  Keni Trail Running
                </h3>
